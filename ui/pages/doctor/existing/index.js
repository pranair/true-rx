        ...
        <div>
            ...
            <Card>
                ...
                <div className="flex m-6">
                    <InputTextarea autoResize placeholder="Description" className="flex-auto align-items-center justify-content-center" value={""} onChange={(e) => setValue(e.target.value)} rows={4} cols={30} />
                </div>
                <div className="flex m-6">
                    <InputTextarea autoResize placeholder="Prescriptions" className="flex-auto align-items-center justify-content-center" value={""} onChange={(e) => setValue(e.target.value)} rows={8} cols={30} />
                </div>
