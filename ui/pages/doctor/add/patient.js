        ...
        <div className="overflow-hidden m-8">
            ...
            <div className="flex">
                ...
                <div className="flex align-items-center justify-content-center m-2 px-5 py-3 ">
                    <InputText id="patient-weight" type="text" placeholder="Weight" className="w-full" />
                </div>
                <div className="flex align-items-center justify-content-center m-2 px-5 py-3 ">
            ...
            <div className="flex">
                <div className="flex-auto align-items-center justify-content-center m-2 px-5 py-3">
                    <InputText id="patient-uid" type="text" placeholder="UID" className="w-full" />
                </div>
                <div className="flex-auto align-items-center justify-content-center m-2 px-5 py-3">
                    <InputText id="patient-password" type="text" placeholder="Password" className="w-full" />
                </div>
            </div>
            <div className="flex">
                <div className="flex-auto align-items-center justify-content-center m-2 px-5 py-3">
...
export default function App() {
    ...
    if (activeIndex == 0) {
        return (
            <div>
                <TRMenu></TRMenu>
                <Card title="" header={<Steps readOnly={true} className='pt-3' model={items} activeIndex={activeIndex} onSelect={(e) => setActiveIndex(e.index)} />}>
        ...
        return (
            <div>
                <TRMenu></TRMenu>
                <Card title="" header={<Steps className='pt-3' model={items} activeIndex={activeIndex} onSelect={(e) => { setActiveIndex(e.index) }} readOnly={true} />}>
