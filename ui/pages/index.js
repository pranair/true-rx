        ...
        <div className="flex justify-content-center align-items-center text-center">
            <div className='h-full mt-8 pt-5'>
                ...
                <div className='flex m-4'>
                    <div className=''>
                        <Avatar size="xlarge" className="m-4 mb-0 p-overlay-badge" image="/doctor.svg" onClick={(e) => {
                    ...
                    <div>
                        <Avatar size="xlarge" className="m-4 mb-0 p-overlay-badge" image="/patient.svg" onClick={(e) => {
                    ...
                    <div>
                        <Avatar size="xlarge" className="m-4 mb-0 p-overlay-badge" image="/pharmacist.svg" onClick={(e) => {
                ...
                <div className='flex flex-column flex justify-content-center align-items-center'>
                    <div className="flex m-3">
                        <span className="p-float-label">
                            <InputText className='w-20rem ' id="username" value={username} onChange={(e) => setUsername(e.target.value)} />
                    ...
                    <Button className='mt-3 w-8' label="Sign In" onClick={(e) => {
                        console.log(active.indexOf(true));
